...
class Container_06472550ab extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_06472550ab $container)
			{
	...
	public function createServiceContainer(): Container_06472550ab
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/Users/andibauer/Repositories/basix-macro/backend',
				'LANG' => 'C.UTF-8',
