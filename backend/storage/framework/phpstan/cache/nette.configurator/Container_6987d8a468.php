...
class Container_6987d8a468 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService067(): PHPStan\Rules\Classes\LocalTypeAliasesCheck
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesCheck(
			[
				'SyncableModel' => '\App\Models\FoodItem|\App\Models\Recipe|\App\Models\RecipeIngredient|\App\Models\DiaryEntry|\App\Models\WeightEntry|\App\Models\WaterEntry|\App\Models\BodyFatEntry|\App\Models\ActivityEntry',
			],
			$this->getService('reflectionProvider'),
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_6987d8a468 $container)
			{
	...
	public function createServiceContainer(): Container_6987d8a468
	{
		return $this;
	}
